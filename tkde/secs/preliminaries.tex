...
A CUDA core executes the same instruction of a warp in a lockstep\footnote{Although the latest Volta architecture supports independent thread scheduling \xxx,
